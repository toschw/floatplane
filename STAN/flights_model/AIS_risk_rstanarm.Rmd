...
test
levels(test$data$parameter)[1] <- "dsaf1"
levels(test$data$parameter)[2] <- "dsaf2"
levels(test$data$parameter)[3] <- "dsaf3"
levels(test$data$parameter)[4] <- "dsaf4"
levels(test$data$parameter)[5] <- "dsaf5"
levels(test$data$parameter)[6] <- "dsaf6"
levels(test$data$parameter)[7] <- "dsaf7"
levels(test$data$parameter)[8] <- "dsaf8"
levels(test$data$parameter)[9] <- "dsaf9"
levels(test$data$parameter)[10] <- "dsaf10"

test <- test + xlab("iteration") + ylab("posterior for theta(j)")
test
