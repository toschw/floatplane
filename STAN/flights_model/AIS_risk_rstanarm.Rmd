...
flights <- read.csv("D:/Dropbox/DATA/2015_Schwoerer_floatplane_survey/FlightPattern/flight_pattern_long2.csv")
...
flights <- flights[!(flights$StartID %in% v) & !(flights$DestID %in% v), ]
