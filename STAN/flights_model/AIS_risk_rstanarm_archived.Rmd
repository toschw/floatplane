...
#importing data archived and update below links before running this Rmd file 
flights <- read.csv(url("https://arcticdata.io/...",      method="libcurl"))
lakeList2  <-  read.csv(url("https://arcticdata.io/...",method="libcurl"))
```
...
ess_fig
ggsave("/ess_fig.tiff", plot = last_plot(), device = "tiff", path = NULL,
...
replicate
ggsave("/replicate.tiff", plot = replicate, device = "tiff", path = NULL,
...
traceplot <- traceplot + xlab("iterations after warm up") +
                          scale_y_continuous(expression(paste( alpha[j])))
traceplot
ggsave("/trace_plots.tiff", plot = traceplot, device = "tiff", path = NULL,
...
compareModels
ggsave("/compareModels.tiff", plot = compareModels, device = "tiff", path = NULL,
...
ggsave("/partialPlot.tiff", plot = partialPlot, device = "tiff", path = NULL,
  scale = 1, width = 140, height = 140, units = "mm",
  dpi = 300, limitsize = TRUE)
```
...
RegionPlot
ggsave("/RegionPlot.tiff", plot = RegionPlot, device = "tiff",
  path = NULL,
...
RegionPlot2
ggsave("/RegionPlot3.tiff", plot = RegionPlot2, device = "tiff",
  path = NULL,
  scale = 1, width = 140, height = 90, units = "mm",
  dpi = 300, limitsize = TRUE)
```
...
spPlot<- spData %>%
  ...
  ylab("") + xlab("posterior predictive distribution") 
spPlot
ggsave("/SeaplaneBases.tiff", plot = spPlot, device = "tiff", path = NULL,
  scale = 1, width = 140, height = 200, units = "mm",
  dpi = 300, limitsize = TRUE)
...
ggsave("/SeaplaneBases_H.tiff", plot = spPlot_H, device = "tiff", path = NULL,
...
prediPlot
ggsave("/prediPlot.tiff", plot = prediPlot, device = "tiff", path = NULL,
  scale = 1, width = 140, height = 90, units = "mm",
  dpi = 300, limitsize = TRUE)
```
...
topSPB2 <- topSPB%>%
  ...
  spread(Region,total)
#write.csv(topSPB,"/TopSeaplaneBasesTable.csv")  
```
