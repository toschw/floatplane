...
## Code by Tobias Schwoerer, 10/28/2016
...
datafit1 <- stan(file="STAN/pilot_ratio_model/beta-bin102816.stan",data=c("J","y","n"), iter = 10000, chains = 4,control=list(adapt_delta=0.8, max_treedepth =10))
...
write.csv(datafit.df, file = "STAN/pilot_ratio_model/datafit.csv",  quote = TRUE, sep = " ",
          eol = "\n", na = "NA", dec = ".", row.names = TRUE,
